...
public class JwtTokenUtil implements Serializable {
    ...
    public JwtTokenUtil(UserService userService, UserRolesService userRolesService) {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        List<UserRoles> userRoles = userRolesService.getUserRoles(user).stream().toList();
        List<GrantedAuthority> grantedAuthorities = new ArrayList<>();

        userRoles.forEach(userRole -> grantedAuthorities.add(new SimpleGrantedAuthority(userRole.getRoleName())));

        AuthenticatedUser authenticatedUser = new AuthenticatedUser(userDetails.getUsername(), grantedAuthorities,
